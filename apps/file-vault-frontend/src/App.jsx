...
// <div
//   className="relative z-10 text-center mx-auto px-8 py-12 bg-white/90 rounded-3xl shadow-2xl border border-gray-100"
...
//               type="submit"
//               disabled={loading}
//               className="flex-1 bg-blue-700 text-white px-4 py-2 rounded-lg font-medium hover:bg-blue-800 transition-colors disabled:opacity-50"
//             >
...
//   return (
//     <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-100 via-white to-slate-200 p-4 relative">
...
//       <div className="relative z-10 text-center max-w-2xl mx-auto px-8 py-12 bg-white/90 rounded-3xl shadow-2xl border border-gray-100">
...
//             className="px-8 py-4 bg-blue-700 text-white rounded-full font-semibold text-lg hover:bg-blue-800 transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105 min-w-[140px]"
//           >
//             Login
//           </button>
//           <button
...
//         </div>
//       </div>
//       {showLogin && <LoginForm onLogin={handleLoginSuccess} onCancel={() => setShowLogin(false)} />}
//       {showSignup && <SignupForm onSignup={handleSignupSuccess} onCancel={() => setShowSignup(false)} />}
//     </div>
//   );
// };
...
// <div className="relative z-10 text-center max-w-6xl mx-auto px-12 py-16 bg-white/90 rounded-3xl shadow-2xl border border-gray-100">
//         <div className="mb-8 flex justify-center">
//           <div className="w-24 h-24 bg-gradient-to-br from-blue-600 to-indigo-700 rounded-2xl flex items-center justify-center shadow-xl">
//             <Upload className="w-12 h-12 text-white" />
//           </div>
...
//       <header className="bg-blue-700 text-white px-6 py-4 shadow-lg">
...
//                   <button className="px-3 py-2 text-sm bg-blue-700 text-gray-700 rounded shadow">Name</button>
...
//   return (
//     <div className="min-h-screen w-full flex flex-col bg-gradient-to-br from-blue-50 to-gray-100">
//       {/* Header */}
...
//                 onClick={() => fileInputRef.current?.click()}
//                 disabled={loading}
//                 className="bg-blue-700 text-white px-6 py-3 rounded-lg font-bold hover:bg-blue-800 transition-colors disabled:opacity-50"
//               >
//                 {loading ? 'Uploading...' : 'Upload File'}
//               </button>
//             </div>
...
//                 </div>
//                 <div className="flex space-x-2">
//                   <button className="px-3 py-2 text-sm bg-blue-700 text-white rounded shadow">Name</button>
//                   <button className="px-3 py-2 text-sm bg-gray-100 text-gray-700 rounded hover:bg-gray-200">
//                     Type
//                   </button>
//                   <button className="px-3 py-2 text-sm bg-gray-100 text-gray-700 rounded hover:bg-gray-200">
